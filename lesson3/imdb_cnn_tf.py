...
train_data = tf.keras.preprocessing.sequence.pad_sequences(train_data, maxlen=seq_len)
test_data = tf.keras.preprocessing.sequence.pad_sequences(test_data, maxlen=seq_len)
